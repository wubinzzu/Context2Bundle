...
class BeamSearchDecoder(decoder.Decoder):
  ...
  def step(self, time, inputs, state, name=None):
    ...
    with ops.name_scope(name, "BeamSearchDecoderStep", (time, inputs, state)):
      ...
      mask = array_ops.one_hot(end_token, array_ops.shape(cell_outputs)[-1], dtype=dtypes.float32)
      ...
      cell_outputs = control_flow_ops.case(
          pred_fn_pairs=pred_fn_pairs,
          default=lambda: cell_outputs, exclusive=True)
